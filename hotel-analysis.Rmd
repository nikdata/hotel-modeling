...
One of things that I like to do before creating or deleting columns and rows is to create another dataframe.
...
- convert the variable hotel to binary (1 for city hotel, 0 for resort)
- impute missing value in meal with 'none' (per data dictionary)
...
chorizo <- chorizo %>%
  select(-arrival_date_year, -arrival_date_month, -arrival_date_week_number, -arrival_date_day_of_month, -stays_in_weekend_nights, -stays_in_week_nights, -adults, -children, -babies, -reservation_status, -reservation_status_date, -adr, -meal, -distribution_channel, -reservation_date)
